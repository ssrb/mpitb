 ...
 * if info==MPI_ERR_NO_SUCH_FILE, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_NO_SUCH_FILE
#define	MPI_ERR_NO_SUCH_FILE MPI_SUCCESS
#endif
...
"MPI_ERR_NO_SUCH_FILE   MPITB constant for corresponding MPI symbol\n\
\n\
