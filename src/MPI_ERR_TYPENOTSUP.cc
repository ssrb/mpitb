...
## ----------------------------------------------------
 */
//#define   NAME	MPI_ERR_TYPENOTSUP
/*
 * ----------------------------------------------------
 * MPITB constant for corresponding MPI symbol
 * if info==MPI_ERR_TYPENOTSUP, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_TYPENOTSUP
#define	MPI_ERR_TYPENOTSUP MPI_SUCCESS
#endif

#define   NAME	MPI_ERR_TYPENOTSUP
GEN_1_INT(NAME)
#undef		MPI_ERR_TYPENOTSUP
DEFUN_DLD(NAME, args, nargout,
"MPI_ERR_TYPENOTSUP     MPITB constant for corresponding MPI symbol\n\
\n\
