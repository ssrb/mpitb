...
## ----------------------------------------------------
 */
//#define   NAME	LAM_MPI_SSI_COLL
/*
 * ----------------------------------------------------
 * MPITB constant for corresponding MPI symbol
 * MPI_Attr_get(MPI_COMM_WORLD, LAM_MPI_SSI_COLL)
 * ----------------------------------------------------
...
#ifndef	LAM_MPI_SSI_COLL
#define	LAM_MPI_SSI_COLL MPI_ANY_TAG
#endif

#define   NAME	LAM_MPI_SSI_COLL
GEN_1_INT(NAME)			 // works if #defined MPI... (LAM/MPI), and
#undef		LAM_MPI_SSI_COLL // does not harm if enum{MPI...} (OpenMPI)
DEFUN_DLD(NAME, args, nargout,
"LAM_MPI_SSI_COLL       MPITB constant for corresponding MPI symbol\n\
\n\
