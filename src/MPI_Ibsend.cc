...
\n\
  SEE ALSO: MPI_Bsend, MPI_Test (_Testall/any/some), MPI_Wait (all/any/some)\n\
\n\
...
\n\
  It is generally a bad idea to use the MPI_Ibsend function, as it guarantees\n\
