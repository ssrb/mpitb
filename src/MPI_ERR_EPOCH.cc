...
## ----------------------------------------------------
 */
//#define   NAME	MPI_ERR_EPOCH
/*
 * ----------------------------------------------------
 * MPITB constant for corresponding MPI symbol
 * if info==MPI_ERR_EPOCH, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_EPOCH
#define	MPI_ERR_EPOCH MPI_SUCCESS
#endif
...
"MPI_ERR_EPOCH          MPITB constant for corresponding MPI symbol\n\
\n\
