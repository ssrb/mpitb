...
## ----------------------------------------------------
 */
//#define   NAME	MPI_ERR_REMOTEDEAD
/*
 * ----------------------------------------------------
 * MPITB constant for corresponding MPI symbol
 * if info==MPI_ERR_REMOTEDEAD, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_REMOTEDEAD
#define	MPI_ERR_REMOTEDEAD MPI_SUCCESS
#endif

#define   NAME	MPI_ERR_REMOTEDEAD
GEN_1_INT(NAME)
#undef		MPI_ERR_REMOTEDEAD
DEFUN_DLD(NAME, args, nargout,
"MPI_ERR_REMOTEDEAD     MPITB constant for corresponding MPI symbol\n\
\n\
