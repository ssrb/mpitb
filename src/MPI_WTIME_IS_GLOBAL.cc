 ...
 * MPI_Attr_get(MPI_COMM_WORLD, MPI_WTIME_IS_GLOBAL)
 * ----------------------------------------------------
 */
...
#undef		MPI_WTIME_IS_GLOBAL // does not harm if enum{MPI...} (OpenMPI)
DEFUN_DLD(NAME, args, nargout,
"MPI_WTIME_IS_GLOBAL    MPITB constant for corresponding MPI symbol\n\
\n\
