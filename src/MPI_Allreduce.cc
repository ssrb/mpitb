...
## ----------------------------------------------------
 */
#define   NAME  MPI_Allreduce
/*
 * ----------------------------------------------------
 * Combines values from all processes and distribute result back to all
...
\n\
  SEE ALSO: MPI_Barrier, MPI_Bcast, MPI_Scatter, MPI_Gather, MPI_Reduce\n\
            collective\n\
\n\
  MPI_Allreduce is a collective operation on comm (all ranks must call it)\n\
\n\
