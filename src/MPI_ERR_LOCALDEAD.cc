...
## ----------------------------------------------------
 */
//#define   NAME	MPI_ERR_LOCALDEAD
/*
 * ----------------------------------------------------
 * MPITB constant for corresponding MPI symbol
 * if info==MPI_ERR_LOCALDEAD, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_LOCALDEAD
#define	MPI_ERR_LOCALDEAD MPI_SUCCESS
#endif

#define   NAME	MPI_ERR_LOCALDEAD
GEN_1_INT(NAME)
#undef		MPI_ERR_LOCALDEAD
DEFUN_DLD(NAME, args, nargout,
"MPI_ERR_LOCALDEAD      MPITB constant for corresponding MPI symbol\n\
\n\
