 ...
 * if info==MPI_ERR_UNSUPPORTED_OPERATION, ..., end
 * ----------------------------------------------------
...
#define	MPI_ERR_UNSUPPORTED_OPERATION MPI_SUCCESS
#endif
...
"MPI_ERR_UNSUPPORTED_OPERATION  MPITB constant for corresponding MPI symbol\n\
\n\
