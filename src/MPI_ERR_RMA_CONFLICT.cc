 ...
 * if info==MPI_ERR_RMA_CONFLICT, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_RMA_CONFLICT
#define	MPI_ERR_RMA_CONFLICT MPI_SUCCESS
#endif
...
"MPI_ERR_RMA_CONFLICT   MPITB constant for corresponding MPI symbol\n\
\n\
