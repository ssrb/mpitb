...
## ----------------------------------------------------
 */
//#define   NAME	MPI_ERR_VALUE
/*
 * ----------------------------------------------------
 * MPITB constant for corresponding MPI symbol
 * if info==MPI_ERR_VALUE, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_VALUE
#define	MPI_ERR_VALUE MPI_SUCCESS
#endif
...
"MPI_ERR_VALUE          MPITB constant for corresponding MPI symbol\n\
\n\
