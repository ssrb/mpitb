 ...
 * if info==MPI_ERR_FILE_EXISTS, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_FILE_EXISTS
#define	MPI_ERR_FILE_EXISTS MPI_SUCCESS
#endif
...
"MPI_ERR_FILE_EXISTS    MPITB constant for corresponding MPI symbol\n\
\n\
