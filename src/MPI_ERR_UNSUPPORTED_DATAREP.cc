 ...
 * if info==MPI_ERR_UNSUPPORTED_DATAREP, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_UNSUPPORTED_DATAREP
#define	MPI_ERR_UNSUPPORTED_DATAREP MPI_SUCCESS
#endif
...
"MPI_ERR_UNSUPPORTED_DATAREP  MPITB constant for corresponding MPI symbol\n\
\n\
