 ...
 * if info==MPI_ERR_DUP_DATAREP, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_DUP_DATAREP
#define	MPI_ERR_DUP_DATAREP MPI_SUCCESS
#endif
...
"MPI_ERR_DUP_DATAREP    MPITB constant for corresponding MPI symbol\n\
\n\
