...
## ----------------------------------------------------
 */
//#define   NAME	LAM_UNIVERSE_NNODES
/*
 * ----------------------------------------------------
 * MPITB constant for corresponding MPI symbol
 * MPI_Attr_get(MPI_COMM_WORLD, LAM_UNIVERSE_NNODES)
 * ----------------------------------------------------
...
#ifndef	LAM_UNIVERSE_NNODES
#define	LAM_UNIVERSE_NNODES MPI_ANY_TAG
#endif

#define   NAME	LAM_UNIVERSE_NNODES
GEN_1_INT(NAME)			    // works if #defined MPI... (LAM/MPI), and
#undef		LAM_UNIVERSE_NNODES // does not harm if enum{MPI...} (OpenMPI)
DEFUN_DLD(NAME, args, nargout,
"LAM_UNIVERSE_NNODES     MPITB constant for corresponding MPI symbol\n\
\n\
