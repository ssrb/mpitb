 ...
 * if info==MPI_ERR_INFO_NOKEY, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_INFO_NOKEY
#define	MPI_ERR_INFO_NOKEY MPI_SUCCESS
#endif
...
"MPI_ERR_INFO_NOKEY     MPITB constant for corresponding MPI symbol\n\
\n\
