 ...
 * if info==MPI_ERR_INFO_VALUE, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_INFO_VALUE
#define	MPI_ERR_INFO_VALUE MPI_SUCCESS
#endif
...
"MPI_ERR_INFO_VALUE     MPITB constant for corresponding MPI symbol\n\
\n\
