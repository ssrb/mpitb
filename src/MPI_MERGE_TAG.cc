...
## ----------------------------------------------------
 */
//#define   NAME	MPI_MERGE_TAG
/*
 * ----------------------------------------------------
 * MPITB constant for corresponding MPI symbol
 * if info==MPI_MERGE_TAG, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_MERGE_TAG
#define	MPI_MERGE_TAG MPI_SUCCESS
#endif
...
"MPI_MERGE_TAG          MPITB constant for corresponding MPI symbol\n\
\n\
  SEE ALSO: misc\n\
\n\
")
