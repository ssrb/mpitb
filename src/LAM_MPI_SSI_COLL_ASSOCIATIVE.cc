...
## ----------------------------------------------------
 */
//#define   NAME	LAM_MPI_SSI_COLL_ASSOCIATIVE
/*
 * ----------------------------------------------------
 * MPITB constant for corresponding MPI symbol
 * MPI_Attr_get(MPI_COMM_WORLD, LAM_MPI_SSI_COLL_ASSOCIATIVE)
 * ----------------------------------------------------
...
#ifndef	LAM_MPI_SSI_COLL_ASSOCIATIVE
#define	LAM_MPI_SSI_COLL_ASSOCIATIVE MPI_ANY_TAG
#endif

#define   NAME	LAM_MPI_SSI_COLL_ASSOCIATIVE
GEN_1_INT(NAME)				     // works if #defined MPI... and
#undef		LAM_MPI_SSI_COLL_ASSOCIATIVE // does not harm if enum{MPI...}
DEFUN_DLD(NAME, args, nargout,
"LAM_MPI_SSI_COLL_ASSOCIATIVE  MPITB constant for corresponding MPI symbol\n\
\n\
