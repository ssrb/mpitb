...
## ----------------------------------------------------
 */
//#define   NAME	MPI_ERR_FLAGS
/*
 * ----------------------------------------------------
 * MPITB constant for corresponding MPI symbol
 * if info==MPI_ERR_FLAGS, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_FLAGS
#define	MPI_ERR_FLAGS MPI_SUCCESS
#endif
...
"MPI_ERR_FLAGS          MPITB constant for corresponding MPI symbol\n\
\n\
