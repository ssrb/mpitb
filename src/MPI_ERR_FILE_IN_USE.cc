 ...
 * if info==MPI_ERR_FILE_IN_USE, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_FILE_IN_USE
#define	MPI_ERR_FILE_IN_USE MPI_SUCCESS
#endif
...
"MPI_ERR_FILE_IN_USE    MPITB constant for corresponding MPI symbol\n\
\n\
