...
#include "hInfo.h"		// PATN_F_INF_STR
...
\n\
  info = MPI_Info_delete (inf, key)\n\
\n\
  inf  (str)	info object (handle created with MPI_Info_create)\n\
...
\n\
  SEE ALSO: MPI_Info_set, MPI_Info_get, MPI_Info_create, MPI_Info_free,\n\
            info\n\
\n\
")
