...
## ----------------------------------------------------
 */
//#define   NAME	LAM_MPI_SSI_COLL_REDUCE_CROSSOVER
/*
 * ----------------------------------------------------
 * MPITB constant for corresponding MPI symbol
 * MPI_Attr_get(MPI_COMM_WORLD, LAM_MPI_SSI_COLL_REDUCE_CROSSOVER)
 * ----------------------------------------------------
...
#ifndef	LAM_MPI_SSI_COLL_REDUCE_CROSSOVER
#define	LAM_MPI_SSI_COLL_REDUCE_CROSSOVER MPI_ANY_TAG
#endif

#define   NAME	LAM_MPI_SSI_COLL_REDUCE_CROSSOVER
GEN_1_INT(NAME)					  // works if #defined &
#undef		LAM_MPI_SSI_COLL_REDUCE_CROSSOVER // doesn't harm if enum
DEFUN_DLD(NAME, args, nargout,
"LAM_MPI_SSI_COLL_REDUCE_CROSSOVER  MPITB constant for corresp. MPI symbol\n\
\n\
