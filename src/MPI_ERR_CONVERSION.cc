 ...
 * if info==MPI_ERR_CONVERSION, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_CONVERSION
#define	MPI_ERR_CONVERSION MPI_SUCCESS
#endif
...
"MPI_ERR_CONVERSION     MPITB constant for corresponding MPI symbol\n\
\n\
