...
## ----------------------------------------------------
 */
//#define   NAME	MPI_ERR_SYSRESOURCE
/*
 * ----------------------------------------------------
 * MPITB constant for corresponding MPI symbol
 * if info==MPI_ERR_SYSRESOURCE, ..., end
 * ----------------------------------------------------
...
#ifndef	MPI_ERR_SYSRESOURCE
#define	MPI_ERR_SYSRESOURCE MPI_SUCCESS
#endif

#define   NAME	MPI_ERR_SYSRESOURCE
GEN_1_INT(NAME)
#undef		MPI_ERR_SYSRESOURCE
DEFUN_DLD(NAME, args, nargout,
"MPI_ERR_SYSRESOURCE    MPITB constant for corresponding MPI symbol\n\
\n\
